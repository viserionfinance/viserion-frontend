...
import {ConcaveBottom, ConcaveProps, ConcaveTop, CurvedSvgBottom, CurvedSvgTop} from './svg/CurvedSvg'
    ...
    return (
        <Wrapper index={index}>
            ...
            {showConcaveTopDivider && (
                <ConcaveTop concaveBackgroundDark={concaveBackgroundDark}
                            concaveBackgroundLight={concaveBackgroundLight}/>
            )}
            {showConcaveBottomDivider && (
                <ConcaveBottom concaveBackgroundDark={concaveBackgroundDark}
                               concaveBackgroundLight={concaveBackgroundLight}/>
            )}
