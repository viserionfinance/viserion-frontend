                                    ...
                                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                                        <RowBetween style={{justifyContent: 'flex-end', fontSize: '14px'}}>
                                            {oneCurrencyIsETH ? (
                                                ...
                                                <StyledInternalLink
                                                    to={`/remove/${currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'METIS' : currencyIdA}/${
                                                        currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'METIS' : currencyIdB
                                                    }`}
                                                >
                                                    {t('Receive METIS')}
                                                </StyledInternalLink>
