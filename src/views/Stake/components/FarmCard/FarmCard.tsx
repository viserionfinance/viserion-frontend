...
const FarmCard: React.FC<FarmCardProps> = ({farm, displayApr, removed, cakePrice, account}) => {
    ...
    // const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('VeFI', '')
    const earnLabel = farm.dual ? farm.dual.earnLabel : t('VeFI + Fees')
    ...
    const isPromotedFarm = farm.token.symbol === 'VeFI'
    return (
